...
import LaptopIcon from './images/icon-laptop.svg'
...
export default function App() {
  return (
    <Wrapper>
      <Spline
        className="spline"
        scene="https://prod.spline.design/7fXlcwOnrFYAhVo2/scene.splinecode"
      />
      <Social>
        <div />
      ...
      <Menu>
        ...
        <button><img src={LaptopIcon} /> Download for Mac</button>
      </Content>
    </Wrapper>
  );
}
